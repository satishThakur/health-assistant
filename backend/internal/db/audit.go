...
// AuditRepository handles database operations for sync audit
...
func (r *AuditRepository) InsertSyncAudit(ctx context.Context, audit *SyncAudit) error {
	query := `
	...
	err := r.db.Pool.QueryRow(
		...
		query,
		audit.SyncStartedAt,
		audit.SyncCompletedAt,
		audit.SyncDurationSeconds,
		audit.UserID,
		audit.DataType,
		audit.TargetDate,
		audit.RecordsFetched,
		audit.RecordsInserted,
		audit.RecordsUpdated,
		audit.EarliestTimestamp,
...
func (r *AuditRepository) GetRecentSyncAudits(
	ctx context.Context,
	userID string,
	limit int,
) ([]SyncAudit, error) {
...
func (r *AuditRepository) GetSyncAuditsByDataType(
	ctx context.Context,
	dataType string,
	limit int,
) ([]SyncAudit, error) {
...
func (r *AuditRepository) GetSyncAuditStats(
	ctx context.Context,
	userID string,
	startDate time.Time,
	endDate time.Time,
